...
@group(0) @binding(1) var<storage, read>       land_mask:      array<f32>;
@group(0) @binding(2) var<storage, read>       kinematic_data: array<vec4<f32>>;
@group(0) @binding(3) var<storage, read>       jfa_nearest:    array<vec2<f32>>;
@group(0) @binding(4) var<storage, read_write> elevation:      array<f32>;
@group(0) @binding(5) var<uniform>             params:         ElevParams;
