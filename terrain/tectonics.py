...
def generate_tectonic_scaffold(
    ...
    *,
    ...
    """Generate deterministic plate partition and boundary class fields."""
    ...
    return TectonicsResult(
        ...
        orogeny_field=zeros,
        rift_field=zeros,
        transform_field=zeros,
        crust_thickness=zeros,
        shelf_proximity=zeros,
    )
...
def _classify_boundaries(
    ...
    *,
    ...
    for dy, dx in directions:
        ...
        region_conv[take] = c[take].astype(np.float32)
